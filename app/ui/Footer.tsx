...
const Footer: React.FC = () => {
    return (
        <footer className="bg-[#647197] text-white pt-6 mt-10">
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-8">
                ...
                {/* Right side text */}
                <div
                    className="text-xs md:text-base text-center flex flex-col md:flex-col md:text-right font-normal md:font-semibold leading-loose">
            ...
            <div className="bg-[#4a5568] text-right py-2 mt-4">
                <p className="mr-8 text-xs md:text-base">Desarrollado por Universidad Tecnológica Nacional - Facultad Regional Tucumán - 2024</p>
            </div>
        </footer>
    );
};
